...
due to equipment wear off the subsystem's behaviour changes in time, and current
models were found to no longer be accurate enough.
...
- cosines of solar angles (in radians)
...
- dataset2 (generated by prepare_data2.py): does not contain any DMOP features at all, but contains 
...
It was found that the feature build from merged commands 305C, 305O, 305P, 306C
...
*In the picture we show the relation between the mask feature and 2551 power line 
...
the 2881 signal appearance and some of them overlap exactly with current) we have
...
In local test in the case of several power lines it was more beneficial to 
...
models were trained on 1st and 2nd Martian years, and tested on the 3rd one.
